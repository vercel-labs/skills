...
- [`next-server-patterns`](../next-server-patterns/SKILL.md) - error boundaries vs data layer
- [`observability-handbook`](../observability-handbook/SKILL.md) - logging in error.tsx
- [`semantic-html-css`](../semantic-html-css/SKILL.md) - accessible error UI
